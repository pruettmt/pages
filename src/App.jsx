...
export default function LandingPage() {
  return (
    <div className="page">
      ...
      <p>I take security seriously — so all sensitive tokens and, if I’m sharing real-world configs, resource names and GUIDs will be s. Sometimes it might feel like overkill, but better safe than sorry.</p>
    </div>
  );
}

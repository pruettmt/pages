...
export default function LandingPage() {
  return (
    <div className="page">
      ...
      <p>The cloud’s always changing — and let’s be honest, sometimes it breaks. This blog is where I share what I’m learning, what I’ve messed up, and what actually works. If it saves you some pain, that’s a win.</p>
